...
本项目发布的所有 GeoIP 文件，请查看 [release 分支](https://github.com/wanjiban/geoip/tree/release)。以下是部分格式 GeoIP 文件的下载地址：
...
- **geoip.dat**：
  - [https://raw.githubusercontent.com/wanjiban/geoip/release/geoip.dat](https://raw.githubusercontent.com/wanjiban/geoip/release/geoip.dat)
  - [https://cdn.jsdelivr.net/gh/wanjiban/geoip@release/geoip.dat](https://cdn.jsdelivr.net/gh/wanjiban/geoip@release/geoip.dat)
- **geoip.dat.sha256sum**：
  - [https://raw.githubusercontent.com/wanjiban/geoip/release/geoip.dat.sha256sum](https://raw.githubusercontent.com/wanjiban/geoip/release/geoip.dat.sha256sum)
  - [https://cdn.jsdelivr.net/gh/wanjiban/geoip@release/geoip.dat.sha256sum](https://cdn.jsdelivr.net/gh/wanjiban/geoip@release/geoip.dat.sha256sum)
- **geoip-only-cn-private.dat**（精简版 GeoIP，只包含 `geoip:cn` 和 `geoip:private`）：
  - [https://raw.githubusercontent.com/wanjiban/geoip/release/geoip-only-cn-private.dat](https://raw.githubusercontent.com/wanjiban/geoip/release/geoip-only-cn-private.dat)
  - [https://cdn.jsdelivr.net/gh/wanjiban/geoip@release/geoip-only-cn-private.dat](https://cdn.jsdelivr.net/gh/wanjiban/geoip@release/geoip-only-cn-private.dat)
- **geoip-only-cn-private.dat.sha256sum**：
  - [https://raw.githubusercontent.com/wanjiban/geoip/release/geoip-only-cn-private.dat.sha256sum](https://raw.githubusercontent.com/wanjiban/geoip/release/geoip-only-cn-private.dat.sha256sum)
  - [https://cdn.jsdelivr.net/gh/wanjiban/geoip@release/geoip-only-cn-private.dat.sha256sum](https://cdn.jsdelivr.net/gh/wanjiban/geoip@release/geoip-only-cn-private.dat.sha256sum)
- **geoip-asn.dat**（精简版 GeoIP，只包含上述新增类别）：
  - [https://raw.githubusercontent.com/wanjiban/geoip/release/geoip-asn.dat](https://raw.githubusercontent.com/wanjiban/geoip/release/geoip-asn.dat)
  - [https://cdn.jsdelivr.net/gh/wanjiban/geoip@release/geoip-asn.dat](https://cdn.jsdelivr.net/gh/wanjiban/geoip@release/geoip-asn.dat)
- **geoip-asn.dat.sha256sum**：
  - [https://raw.githubusercontent.com/wanjiban/geoip/release/geoip-asn.dat.sha256sum](https://raw.githubusercontent.com/wanjiban/geoip/release/geoip-asn.dat.sha256sum)
  - [https://cdn.jsdelivr.net/gh/wanjiban/geoip@release/geoip-asn.dat.sha256sum](https://cdn.jsdelivr.net/gh/wanjiban/geoip@release/geoip-asn.dat.sha256sum)
- **cn.dat**（精简版 GeoIP，只包含 `geoip:cn`）：
  - [https://raw.githubusercontent.com/wanjiban/geoip/release/cn.dat](https://raw.githubusercontent.com/wanjiban/geoip/release/cn.dat)
  - [https://cdn.jsdelivr.net/gh/wanjiban/geoip@release/cn.dat](https://cdn.jsdelivr.net/gh/wanjiban/geoip@release/cn.dat)
- **cn.dat.sha256sum**：
  - [https://raw.githubusercontent.com/wanjiban/geoip/release/cn.dat.sha256sum](https://raw.githubusercontent.com/wanjiban/geoip/release/cn.dat.sha256sum)
  - [https://cdn.jsdelivr.net/gh/wanjiban/geoip@release/cn.dat.sha256sum](https://cdn.jsdelivr.net/gh/wanjiban/geoip@release/cn.dat.sha256sum)
- **private.dat**（精简版 GeoIP，只包含 `geoip:private`）：
  - [https://raw.githubusercontent.com/wanjiban/geoip/release/private.dat](https://raw.githubusercontent.com/wanjiban/geoip/release/private.dat)
  - [https://cdn.jsdelivr.net/gh/wanjiban/geoip@release/private.dat](https://cdn.jsdelivr.net/gh/wanjiban/geoip@release/private.dat)
- **private.dat.sha256sum**：
  - [https://raw.githubusercontent.com/wanjiban/geoip/release/private.dat.sha256sum](https://raw.githubusercontent.com/wanjiban/geoip/release/private.dat.sha256sum)
  - [https://cdn.jsdelivr.net/gh/wanjiban/geoip@release/private.dat.sha256sum](https://cdn.jsdelivr.net/gh/wanjiban/geoip@release/private.dat.sha256sum)
- **所有国家 / 地区 / 新增类别**的 dat 格式文件，请查看本项目 `release` 分支下的 [dat 目录](https://github.com/wanjiban/geoip/tree/release/dat)。
...
geodata-mode: true
geox-url:
  geoip: "https://cdn.jsdelivr.net/gh/wanjiban/geoip@release/geoip.dat"
```
</details>
...
- **GeoLite2-Country.mmdb**：
  - [https://raw.githubusercontent.com/wanjiban/geoip/release/GeoLite2-Country.mmdb](https://raw.githubusercontent.com/wanjiban/geoip/release/GeoLite2-Country.mmdb)
  - [https://cdn.jsdelivr.net/gh/wanjiban/geoip@release/GeoLite2-Country.mmdb](https://cdn.jsdelivr.net/gh/wanjiban/geoip@release/GeoLite2-Country.mmdb)
- **GeoLite2-Country.mmdb.sha256sum**：
  - [https://raw.githubusercontent.com/wanjiban/geoip/release/GeoLite2-Country.mmdb.sha256sum](https://raw.githubusercontent.com/wanjiban/geoip/release/GeoLite2-Country.mmdb.sha256sum)
  - [https://cdn.jsdelivr.net/gh/wanjiban/geoip@release/GeoLite2-Country.mmdb.sha256sum](https://cdn.jsdelivr.net/gh/wanjiban/geoip@release/GeoLite2-Country.mmdb.sha256sum)
...
- **GeoLite2-ASN.mmdb**：
  - [https://raw.githubusercontent.com/wanjiban/geoip/release/GeoLite2-ASN.mmdb](https://raw.githubusercontent.com/wanjiban/geoip/release/GeoLite2-ASN.mmdb)
  - [https://cdn.jsdelivr.net/gh/wanjiban/geoip@release/GeoLite2-ASN.mmdb](https://cdn.jsdelivr.net/gh/wanjiban/geoip@release/GeoLite2-ASN.mmdb)
- **GeoLite2-ASN.mmdb.sha256sum**：
  - [https://raw.githubusercontent.com/wanjiban/geoip/release/GeoLite2-ASN.mmdb.sha256sum](https://raw.githubusercontent.com/wanjiban/geoip/release/GeoLite2-ASN.mmdb.sha256sum)
  - [https://cdn.jsdelivr.net/gh/wanjiban/geoip@release/GeoLite2-ASN.mmdb.sha256sum](https://cdn.jsdelivr.net/gh/wanjiban/geoip@release/GeoLite2-ASN.mmdb.sha256sum)
...
- **Country-without-asn.mmdb**（传统版 GeoIP，只包含国家/地区类别，不包含上述新增类别。建议优先使用）：
  - [https://raw.githubusercontent.com/wanjiban/geoip/release/Country-without-asn.mmdb](https://raw.githubusercontent.com/wanjiban/geoip/release/Country-without-asn.mmdb)
  - [https://cdn.jsdelivr.net/gh/wanjiban/geoip@release/Country-without-asn.mmdb](https://cdn.jsdelivr.net/gh/wanjiban/geoip@release/Country-without-asn.mmdb)
- **Country-without-asn.mmdb.sha256sum**：
  - [https://raw.githubusercontent.com/wanjiban/geoip/release/Country-without-asn.mmdb.sha256sum](https://raw.githubusercontent.com/wanjiban/geoip/release/Country-without-asn.mmdb.sha256sum)
  - [https://cdn.jsdelivr.net/gh/wanjiban/geoip@release/Country-without-asn.mmdb.sha256sum](https://cdn.jsdelivr.net/gh/wanjiban/geoip@release/Country-without-asn.mmdb.sha256sum)
- **Country.mmdb**（增强版 GeoIP，包含国家/地区类别，以及上述新增类别。但由于 MaxMind mmdb 格式限制，部分国家/地区类别的 IP 地址数据不如上述 **Country-without-asn.mmdb** 准确）：
  - [https://raw.githubusercontent.com/wanjiban/geoip/release/Country.mmdb](https://raw.githubusercontent.com/wanjiban/geoip/release/Country.mmdb)
  - [https://cdn.jsdelivr.net/gh/wanjiban/geoip@release/Country.mmdb](https://cdn.jsdelivr.net/gh/wanjiban/geoip@release/Country.mmdb)
- **Country.mmdb.sha256sum**：
  - [https://raw.githubusercontent.com/wanjiban/geoip/release/Country.mmdb.sha256sum](https://raw.githubusercontent.com/wanjiban/geoip/release/Country.mmdb.sha256sum)
  - [https://cdn.jsdelivr.net/gh/wanjiban/geoip@release/Country.mmdb.sha256sum](https://cdn.jsdelivr.net/gh/wanjiban/geoip@release/Country.mmdb.sha256sum)
- **Country-only-cn-private.mmdb**（精简版 GeoIP，只包含 `GEOIP,CN` 和 `GEOIP,PRIVATE`）：
  - [https://raw.githubusercontent.com/wanjiban/geoip/release/Country-only-cn-private.mmdb](https://raw.githubusercontent.com/wanjiban/geoip/release/Country-only-cn-private.mmdb)
  - [https://cdn.jsdelivr.net/gh/wanjiban/geoip@release/Country-only-cn-private.mmdb](https://cdn.jsdelivr.net/gh/wanjiban/geoip@release/Country-only-cn-private.mmdb)
- **Country-only-cn-private.mmdb.sha256sum**：
  - [https://raw.githubusercontent.com/wanjiban/geoip/release/Country-only-cn-private.mmdb.sha256sum](https://raw.githubusercontent.com/wanjiban/geoip/release/Country-only-cn-private.mmdb.sha256sum)
  - [https://cdn.jsdelivr.net/gh/wanjiban/geoip@release/Country-only-cn-private.mmdb.sha256sum](https://cdn.jsdelivr.net/gh/wanjiban/geoip@release/Country-only-cn-private.mmdb.sha256sum)
- **Country-asn.mmdb**（精简版 GeoIP，只包含上述新增类别）：
  - [https://raw.githubusercontent.com/wanjiban/geoip/release/Country-asn.mmdb](https://raw.githubusercontent.com/wanjiban/geoip/release/Country-asn.mmdb)
  - [https://cdn.jsdelivr.net/gh/wanjiban/geoip@release/Country-asn.mmdb](https://cdn.jsdelivr.net/gh/wanjiban/geoip@release/Country-asn.mmdb)
- **Country-asn.mmdb.sha256sum**：
  - [https://raw.githubusercontent.com/wanjiban/geoip/release/Country-asn.mmdb.sha256sum](https://raw.githubusercontent.com/wanjiban/geoip/release/Country-asn.mmdb.sha256sum)
  - [https://cdn.jsdelivr.net/gh/wanjiban/geoip@release/Country-asn.mmdb.sha256sum](https://cdn.jsdelivr.net/gh/wanjiban/geoip@release/Country-asn.mmdb.sha256sum)
...
geodata-mode: false
geox-url:
  mmdb: "https://cdn.jsdelivr.net/gh/wanjiban/geoip@release/Country.mmdb"
  asn: "https://cdn.jsdelivr.net/gh/wanjiban/geoip@release/GeoLite2-ASN.mmdb"
```
</details>
...
请查看本项目 `release` 分支下的 [srs 目录](https://github.com/wanjiban/geoip/tree/release/srs)。
  ...
  "rule_set": [
    {
      ...
      "type": "remote",
      "format": "binary",
      "url": "https://cdn.jsdelivr.net/gh/wanjiban/geoip@release/srs/cn.srs"
    },
    {
      "tag": "geoip-us",
      "type": "remote",
      "format": "binary",
      "url": "https://cdn.jsdelivr.net/gh/wanjiban/geoip@release/srs/us.srs"
    }
  ]
}
```
...
请查看本项目 `release` 分支下的 [mrs 目录](https://github.com/wanjiban/geoip/tree/release/mrs)。
...
rule-providers:
  cn-cidr:
    ...
    behavior: ipcidr
    format: mrs
    url: "https://cdn.jsdelivr.net/gh/wanjiban/geoip@release/mrs/cn.mrs"
  ...
  google-cidr:
    ...
    behavior: ipcidr
    format: mrs
    url: "https://cdn.jsdelivr.net/gh/wanjiban/geoip@release/mrs/google.mrs"
...
请查看本项目 `release` 分支下的 [clash 目录](https://github.com/wanjiban/geoip/tree/release/clash)。
...
rule-providers:
  cn-cidr:
    ...
    behavior: ipcidr
    format: yaml
    url: "https://cdn.jsdelivr.net/gh/wanjiban/geoip@release/clash/ipcidr/cn.txt"
  ...
  telegram-cidr:
    ...
    behavior: ipcidr
    format: yaml
    url: "https://cdn.jsdelivr.net/gh/wanjiban/geoip@release/clash/ipcidr/telegram.txt"
...
请查看本项目 `release` 分支下的 [surge 目录](https://github.com/wanjiban/geoip/tree/release/surge)。
...
```conf
[Rule]
RULE-SET,https://cdn.jsdelivr.net/gh/wanjiban/geoip@release/surge/us.txt,REJECT
RULE-SET,https://cdn.jsdelivr.net/gh/wanjiban/geoip@release/surge/cn.txt,DIRECT
RULE-SET,https://cdn.jsdelivr.net/gh/wanjiban/geoip@release/surge/telegram.txt,PROXY,no-resolve
```
</details>
...
请查看本项目 `release` 分支下的 [text 目录](https://github.com/wanjiban/geoip/tree/release/text)。

---

### Nginx `allow` 和 `deny` 文件

请查看本项目 `release` 分支下的 [nginx 目录](https://github.com/wanjiban/geoip/tree/release/nginx)。
...
- **本地生成**：
  ...
  - 拉取项目代码: `git clone https://github.com/wanjiban/geoip.git`
  - 进入项目根目录：`cd geoip`
  - 修改配置文件 `config.json`
...
- **本地生成**：如果需要使用 MaxMind 官方 GeoLite2 数据文件，需要提前从 MaxMind 下载，或者从本项目 [release 分支](https://github.com/wanjiban/geoip/tree/release)下载（文件名以 `GeoLite2` 为前缀的文件），并解压缩到名为 `geolite2` 的目录。
...
可通过 `go install -v github.com/wanjiban/geoip@latest` 直接安装 CLI 工具。
